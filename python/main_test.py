...
if PUMP_CALIBRATION:
    ...
    returncode=subprocess.call("python3 operant_test.py " +
                    "-schedule " + schedule +
                    " -ratio " + str(ratio) +
    ...
    #         # print("Mprelapsed= " +str(prelapsed))
    #         # print("Mlapsed= " +str(lapsed))
            
    #         difflapsed = lapsed - prelapsed
    #         if difflapsed > 70:
    #             sTime = sTime + difflapsed
    #             print("nlapsed= " +str(lapsed))
    #             lapsed = time.time() - sTime
    #             print("nprelapsed= " +str(prelapsed))
    #             print("nlapsed= " +str(lapsed))
    #             #break
    #         else:
    #             prelapsed=lapsed
    #             # print("prelapsed= " +str(prelapsed))
    #             # print("lapsed= " +str(lapsed))
    #     except:
